...
class TweeterToRdf[Rdf <: RDF](implicit diesel: Diesel[Rdf]) extends (Status => List[Rdf#Graph]) {
  ...
  object TwitterPrefix {
    def apply[Rdf <: RDF](implicit ops: RDFOperations[Rdf]) = new TwitterPrefix[Rdf]
  }


  class TwitterPrefix[Rdf <: RDF](implicit ops: RDFOperations[Rdf]) extends PrefixBuilder("twitter", "http://example.com/twitter/ns#") {
  ...
  object SIOCPrefix {
    def apply[Rdf <: RDF](implicit ops: RDFOperations[Rdf]) = new SIOCPrefix
  }


  class SIOCPrefix[Rdf <: RDF](implicit ops: RDFOperations[Rdf]) extends PrefixBuilder("sioc", "http://rdfs.org/sioc/ns#") {
